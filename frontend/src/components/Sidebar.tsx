  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
        <span className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 text-4xl text-bodydark1 duration-300 ease-in-out dark:hover:bg-meta-4 `}>ProPanel</span>
