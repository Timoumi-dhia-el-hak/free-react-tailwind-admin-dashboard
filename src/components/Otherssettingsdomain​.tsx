...
const Otherssettingsdomain = () => {
  return (
    <>
      <Breadcrumb pageName="Others settings domain" />
      <div
                ...
                <div className="flex flex-col gap-5.5 p-6.5">
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="In a few words, explain what this site is about"
                  ...
                  <div>
                    ...
                    <input type="email" placeholder="Site Address (URL)"
                      className="w-full rounded-lg border-[1.5px]  border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                  </div>
                  <div>
                    <label className="mb-3  block font-medium text-sm text-black dark:text-white">
                    ...
                    <input type="email" placeholder="Administration Email Address"
                      className="w-full rounded-lg border-[1.5px]  border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                  </div>
...
export default Otherssettingsdomain;
