...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
 ...
 useEffect(() => {
  ...
  return (
    <aside
      ref={sidebar}
      className={` left-0 top-0 z-9999 flex h-screen flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${ !sideopen ? 'translate-x-full' : ' -translate-x-0'}`} >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className={`relative flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 ${ !sideopen ? 'w-30' : ' w-72'} `}>
        ...
        <button
          ...
          className={'flex items-center justify-center p-0.5 bg-gray-800 focus:outline-none  focus:ring-gray-500 hover:bg-graydark dark:hover:bg-meta-4 absolute right-3 top-8 '}>
          <svg
            className={`fill-current ${ !sideopen && "rotate-180"}`} 
            width="20"
            height="18"
            viewBox="0 0 20 18"
            fill="none"
      ...
      <div className={`no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear ${ !sideopen ? 'w-30' : ' w-72'} `}>
        {/* <!-- Sidebar Menu --> */}
                    ...
                    <React.Fragment>
                     ...
                     <NavLink
                      ...
                      >
                        ...
                        <h1 className={`${ !sideopen ? 'scale-0' : ' scale-1'}`}>Authentication</h1>
                        <svg
 ...
 <li>
                ...
                >
                 ...
                 <h1 className={`${ !sideopen ? 'scale-0' : ' scale-1'}`}>Users</h1>
                </NavLink>
              </li>
              {/* <!-- Menu Item  Users--> */}
              ...
              <li>
                <NavLink
                  to="/files"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('Files Manager') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                   <span className='text-2xl block float-left'> 
                   <FaRegFile />
                 </span>
                  <h1 className={`${ !sideopen ? 'scale-0' : ' scale-1'}`}>File Manager</h1> 
                </NavLink>
              </li>
              {/* <!-- Menu Item  File Manager --> */}
              {/* <!-- Menu Item Settings --> */}
              <li>
              <SidebarLinkGroup
                  activeCondition={
                    pathname === '/setting' || pathname.includes('settting')
                  }
                >
                  {(handleClick, open) => {
                    return (
              <React.Fragment>
                ...
                <span className='text-2xl block float-left'> 
                  ...
                  <h1 className={`${ !sideopen ? 'scale-0' : ' scale-1'}`}>Settings</h1> 
                  <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                            open && 'rotate-180'
                          }`}
                ...
                <div
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/Otherssettingsdomain"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              Others settings domain
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
